...
export default function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // email append nahi kar rahe — backend pe change nahi hona chahiye
      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-900
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="relative group">
            <img
              src={previewUrl || `https://ui-avatars.com/api/?name=${user?.name}&background=6366f1&color=fff`}
              alt="Profile"
        ...
        {/* Alerts */}
        {message && (
          <div className="mb-5 flex items-center gap-2.5 p-3 rounded-lg
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="johndoe"
                className="w-full h-10 pl-7 pr-3 text-sm rounded-lg
                           bg-gray-50 dark:bg-gray-800
                           border border-gray-200 dark:border-gray-700
                           text-gray-900 dark:text-white placeholder:text-gray-400
                           focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400
          ...
          {/* Email — readonly, Google users ke liye bhi same */}
          <div>
            <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">
              Email Address
              <span className="ml-1.5 text-gray-400">(cannot be changed)</span>
            </label>
            <input
              type="email"
              value={user?.email || ""}
